...
while i > 0:
    for j in range(nLevels - 1):
        ...
        ty2 = y[j+1][i]
        ty3 = y[j+1][i-1]
        print '<a xlink:href="javascript:void(0)"><polygon id = "segment' + str(i) + str(j) + '1" onclick="colorChange(\'segment' + str(i) + str(j) + '1\')" class="slice-' + str(i) + '" points="', tx1, ty1, tx2, ty2, tx3, ty3, tx4, ty4, '" /></a>'
...
for j in range(nLevels - 1):
    ...
    ty2 = y[j+1][0]
    ty3 = y[j+1][7]
    print '<a xlink:href="javascript:void(0)"><polygon id = "segment' + str(0) + str(j) + '1" onclick="colorChange(\'segment' + str(0) + str(j) + '1\')" class="slice-0" points="', tx1, ty1, tx2, ty2, tx3, ty3, tx4, ty4, '" /></a>'
